...
export function normalizeCandidateEmail(email) {
    return email.trim().toLowerCase();
}
export function normalizeCandidatePhone(phone) {
    return phone.replace(/\D/g, '').slice(0, 10);
}
async function findAadhaarConflict(aadhaarNumber, excludeId) {
...
export async function findCandidateFieldConflict(input, excludeId) {
...
export function buildDuplicateVerificationFailure(types, candidateId, conflict) {
...
//# sourceMappingURL=candidateUniqueness.js.map