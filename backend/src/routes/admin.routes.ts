...
router.get('/users', async (_req: Request, res: Response, _next: NextFunction): Promise<void> => {
  try {
...
router.get('/candidates', async (req: Request, res: Response, _next: NextFunction): Promise<void> => {
  try {
...
router.patch('/users/:id/role', async (req: Request, res: Response, _next: NextFunction): Promise<void> => {
  try {
...
router.get('/stats', async (_req: Request, res: Response, _next: NextFunction): Promise<void> => {
  try {
    const [
      users,
      candidates,
...
router.delete('/candidates/:id', async (req: Request, res: Response, _next: NextFunction): Promise<void> => {
  try {
    const { id } = req.params as { id: string };
...
router.delete('/users/:id', async (req: AuthRequest, res: Response, _next: NextFunction): Promise<void> => {
  try {
    const { id } = req.params as { id: string };
